...
const YOUR_SERVICE_ID = "service_i0sto8j";
const YOUR_TEMPLATE_ID = "template_xppsbz8"
const YOUR_PUBLIC_KEY = "LYp3wwSQwAih6qnsW";
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(YOUR_SERVICE_ID, YOUR_TEMPLATE_ID, form.current, YOUR_PUBLIC_KEY)
      .then((result) => {
        ...
        console.log("message sent to Monu Yadav Successfully");
        Swal.fire({
          icon: 'success',
        ...
        >
          ...
          >
            <div className='flex gap-8'>
              <input name="user_name" className='input bg-input' type='text' placeholder='Your name' />
              <input name="user_email" className='input bg-input' type='email' placeholder='Your email' />
            </div>
            <input name="user_subject" className='input bg-input' type='text' placeholder='Subject' />
            <textarea
            ...
            <button type='submit' value="Send" className="bg-black relative inline-flex items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold rounded-full group">
